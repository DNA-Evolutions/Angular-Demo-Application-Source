...
export class IntroductionComponent {
  constructor(public dialog: MatDialog,public dialogRef: MatDialogRef<IntroductionComponent>) {}
  ...
  openHowtoDialog(): void {
    ...
    let takeUpPercentage = 80; // take up to 80% of the screen size
  ...
  const relativeHeight = (relativeWidth * 9) / 16 + 160; // 16:9 to which we add 140 px for the dialog action buttons ("close")
