...
export class ReadDatabaseServiceControllerService {
     ...
     */
    public findError(databaseInfoSearch: DatabaseInfoSearch, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/event-stream'}): Observable<Array<JOptOptimizationError>>;
    public findError(databaseInfoSearch: DatabaseInfoSearch, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/event-stream'}): Observable<HttpResponse<Array<JOptOptimizationError>>>;
    public findError(databaseInfoSearch: DatabaseInfoSearch, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/event-stream'}): Observable<HttpEvent<Array<JOptOptimizationError>>>;
    public findError(databaseInfoSearch: DatabaseInfoSearch, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/event-stream'}): Observable<any> {
