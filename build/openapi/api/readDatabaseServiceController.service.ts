...
export class ReadDatabaseServiceControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findsSolutionInfos(databaseInfoSearch: DatabaseInfoSearch, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/event-stream'}): Observable<Array<DatabaseInfoSearchResult>>;
    public findsSolutionInfos(databaseInfoSearch: DatabaseInfoSearch, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/event-stream'}): Observable<HttpResponse<Array<DatabaseInfoSearchResult>>>;
    public findsSolutionInfos(databaseInfoSearch: DatabaseInfoSearch, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/event-stream'}): Observable<HttpEvent<Array<DatabaseInfoSearchResult>>>;
    public findsSolutionInfos(databaseInfoSearch: DatabaseInfoSearch, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/event-stream'}): Observable<any> {
        if (databaseInfoSearch === null || databaseInfoSearch === undefined) {
