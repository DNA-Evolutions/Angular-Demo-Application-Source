...
import { SimpleResourceDepotAllOf } from './simpleResourceDepotAllOf';
import { ILoadCapacity } from './iLoadCapacity';


export interface SimpleResourceDepot extends IResourceDepot { 
    maximalUnitMatchedCapacity?: number;
    capacityUnitMap?: { [key: string]: number; };
    getPerKilometerCostFactorMap?: { [key: string]: number; };
    /**
     * The typeName of the object
     */
    typeName: string;
    emptyAtEndOfRouteFactorMap?: { [key: string]: number; };
}
