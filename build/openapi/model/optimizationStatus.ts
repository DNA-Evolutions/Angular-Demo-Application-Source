...
export interface OptimizationStatus { 
     ...
     * The status of the optimization
     */
    status: OptimizationStatus.StatusEnum;
}
export namespace OptimizationStatus {
    export type StatusEnum = 'UNKNOWN' | 'ERROR' | 'SUCCESS_WITH_SOLUTION' | 'SUCCESS_WITHOUT_SOLUTION';
    export const StatusEnum = {
        Unknown: 'UNKNOWN' as StatusEnum,
        Error: 'ERROR' as StatusEnum,
        SuccessWithSolution: 'SUCCESS_WITH_SOLUTION' as StatusEnum,
        SuccessWithoutSolution: 'SUCCESS_WITHOUT_SOLUTION' as StatusEnum
    };
}
